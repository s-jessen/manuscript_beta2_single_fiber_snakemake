...
fit <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se),
                    design, block=se$id,
...
#Fit the linear model
fit <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se_ter),
...
#Fit the linear model
fit <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se_res),
...
#Fit the linear model
fit_i_and_ii_interaction <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se),
                                  design_i_and_ii_interaction,
                                  block=se$id,
...
#Fit the linear model
fit_i_interaction <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se_i_interaction),
                                  design_i_interaction,
                                  block=se_i_interaction$id,
...
#Fit the linear model
fit_ii_interaction <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se_ii_interaction),
                                  design_ii_interaction,
                                  block=se_ii_interaction$id,
...
#Fit the linear model
fit_myh_ii_vs_i <- limma::eBayes(limma::lmFit(SummarizedExperiment::assay(se_myh_ii_vs_i), design_myh_ii_vs_i, block=se_myh_ii_vs_i$id, correlation=correlation_myh_ii_vs_i$consensus))
